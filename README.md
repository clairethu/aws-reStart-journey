# aws-reStart-journey
A comeback journey in tech: Documenting my path through the AWS re/Start program as I refresh and keep sharpening my technical skills.
...
I am currently transitioning into a **Cloud Practitioner** role, bridging my foundational knowledge of Linux with the scalable power of AWS.
...
* **Economics:** Understanding the "Pay-as-you-go" model and AWS Global Infrastructure.
...
- [ ] **Phase 3: Automation** - Integrating Python and Shell scripting for Cloud tasks.
- [ ] **Phase 4: Certification** - Achieving AWS Certified Cloud Practitioner.
...
> "Technology is best when it brings people together and solves real-world problems. This repo is my commitment to continuous learning and technical excellence."
